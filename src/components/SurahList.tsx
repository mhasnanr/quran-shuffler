...
import { Check, ChevronDown, ChevronUp, Star, Search, Maximize2, Minimize2 } from 'lucide-react';
    ...
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        <h2 className="text-sm font-medium text-muted-foreground uppercase tracking-wider">
          Surahs ({selectedChunks.length} chunks)
        </h2>
      ...
      <div className="max-h-80 space-y-2 overflow-y-auto rounded-xl bg-card p-3 shadow-card">
        {filteredSurahs.length === 0 ? (
          <p className="text-center text-sm text-muted-foreground py-4">No surahs found</p>
        ) : (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2">
                        ...
                        {hasMultipleChunks && !isSurahIncludedAsFull(surah.number) && (
                          <span className="text-[10px] text-muted-foreground bg-muted px-1.5 py-0.5 rounded">
                            {surah.verses} ayat
                          </span>
                        )}
                        {isSurahIncludedAsFull(surah.number) && (
